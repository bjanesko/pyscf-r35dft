...
from pyscf.r35dft import numint, r35work
...
def get_veff(ks, mol=None, dm=None, dm_last=0, vhf_last=0, hermi=1):
    ...
    if hermi == 2:  # because rho = 0
        ...
        n, exc, vxc = ni.nr_rks(mol, ks.grids, ks.xc, dm, max_memory=max_memory, molr35=ks.molr35,r35beta=ks.r35beta)
        if ks.nlc:
...
def _dft_common_init_(mf, xc='LDA,VWN',r35beta=None):
    mf.xc = xc
    mf.nlc = ''
    mf.r35beta = r35beta # BGJ 
    mf.molr35= None # BGJ 
...
class KohnShamDFT(object):
    ...
    Attributes for Kohn-Sham DFT:
        ...
        r35beta : list
            Parameter beta and other parameters for the rung-3.5 functional piece 
    ...
    def dump_flags(self, verbose=None):
        ...
        if self.r35beta is not None: # BGJ 
            log.info('R35 input beta = %s', self.r35beta)
...
class RKS(KohnShamDFT, hf.RHF):
    ...
    def __init__(self, mol, xc='LDA,VWN', r35beta='Default'):
        hf.RHF.__init__(self, mol)
        KohnShamDFT.__init__(self, xc, r35beta)

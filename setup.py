...
NAME = 'pyscf-r35dft'
AUTHOR = 'Jonah Morgan, Benjamin Janesko '
AUTHOR_EMAIL = 'b.janesko@tcu.edu'
DESCRIPTION  = 'PySCF implementation of rung-3.5 density functionals and interpretive tools '
SO_EXTENSIONS = {
}
